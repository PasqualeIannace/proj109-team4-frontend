...
<template>
    <section class="">
        <div class="container">
            <div class="row">
                <div class="col-6 text-white padding ubuntu-mediu">
                    ...
                    <h4><strong>La nostra mission</strong></h4>
                    ...
                    <h4><strong>Perché scegliere Deliveboo?</strong></h4>
                    <ul>
                    ...
                    <h4>Il tuo food delivery di fiducia!</h4>
                </div>
